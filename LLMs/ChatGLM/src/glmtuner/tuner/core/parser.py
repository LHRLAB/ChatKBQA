...
def get_train_args(
    ...
    if training_args.local_rank != -1 and training_args.ddp_find_unused_parameters is None:
        ...
        training_args = replace(training_args, ddp_find_unused_parameters=False)

    training_args = replace(training_args, optim = "adamw_torch" if training_args.optim == "adamw_hf" else training_args.optim) # suppress warning
