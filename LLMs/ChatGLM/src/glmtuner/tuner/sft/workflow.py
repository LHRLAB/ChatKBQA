...
def run_sft(
    ...
    training_args = replace(training_args, generation_max_length = training_args.generation_max_length if \
                training_args.generation_max_length is not None else data_args.max_target_length)
    training_args = replace(training_args, generation_num_beams = data_args.eval_num_beams if \
