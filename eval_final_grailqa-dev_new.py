...
def _parse_args():
    ...
    parser.add_argument('--pred_file', default='Reading/LLaMA2-13b/GrailQA-dev_Freebase_NQ_lora_epoch10/evaluation_beam/beam_test_top_k_predictions.json', help='topk prediction file')
...
def aggressive_top_k_eval_new(split, predict_file, dataset):
    ...
    elif dataset == "GrailQA-dev":
        train_gen_dataset = load_json('data/GrailQA-dev/generation/merged/GrailQA-dev_train.json')
        test_gen_dataset = load_json('data/GrailQA-dev/generation/merged/GrailQA-dev_test.json')
        dev_gen_dataset = None 
