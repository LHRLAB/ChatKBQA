...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/GrailQA-dev/origin/grailqa_v1.0_dev.json')
    parser.add_argument('--predict', type=str, default='Reading/LLaMA2-13b/GrailQA-dev_Freebase_NQ_lora_epoch10/evaluation_beam/beam_test_top_k_predictions.json_output.json', help='The path to predictions')
